// app/api/drive/gallery/route.ts
...
export const dynamic = "force-dynamic" // we set our own caching headers below
...
export async function GET(request: Request) {
  ...
  try {
    ...
    // Folder view — this folder contains collections (subfolders).
    ...
    // Image view — leaf folder of images.
    const drive = getDriveClient()
