...
import type { ContentTimelineChannel } from "@/lib/marketing/content-timeline"
...
const CHANNEL_COLORS: Partial<Record<ContentTimelineChannel, string>> = {
  linkedin: "text-[#0A66C2]",
  instagram: "text-pink-600",
  facebook: "text-[#1877F2]",
  website: "text-slate-600",
  email: "text-amber-700",
  "google-ads": "text-emerald-700",
  pr: "text-violet-600",
  internal: "text-gray-500",
}

export function ContentTimelineChannelIcon({
  channel,
  className,
}: {
  ...
  const color = CHANNEL_COLORS[channel] ?? "text-muted-foreground"
  const iconClass = cn("h-3.5 w-3.5 shrink-0", color, className)
