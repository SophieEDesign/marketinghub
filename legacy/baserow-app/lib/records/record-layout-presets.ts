...
export const RECORD_LAYOUT_PRESETS: Record<Exclude<RecordLayoutType, "generic">, RecordLayoutPreset> = {
  ...
  asset: {
    ...
    statusAliases: aliases(["status", "category", "hub category", "hub_category"]),
    mediaPreviewAliases: aliases([
      "thumbnail",
      "preview",
      "image",
      "attachments",
    ...
    sections: [
      ...
      { id: "tags", label: "Tags", aliases: aliases(["tag", "tags", "keyword"]) },
      {
        ...
        aliases: aliases(["link to table", "link_to_table", "linked record", "campaign", "event", "content", "task"]),
      },
    ],
  },
  content: {
