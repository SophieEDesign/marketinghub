 ...
 * - Layout toggles (show detail panel, show blocks section)
 * 
    ...
    <div className="space-y-6">
      <Tabs value={activeSettingsTab} onValueChange={setActiveSettingsTab} className="w-full">
        <TabsList className="flex w-full flex-wrap h-auto gap-1 p-1">
          ...
          <TabsTrigger value="left_panel" className="flex-1 min-w-[4.5rem] text-xs sm:text-sm">
            Left Panel
          </TabsTrigger>
          <TabsTrigger value="detail_panel" className="flex-1 min-w-[4.5rem] text-xs sm:text-sm">
            Detail Panel
          </TabsTrigger>
          <TabsTrigger value="permissions" className="flex-1 min-w-[4.5rem] text-xs sm:text-sm">
            Permissions
          </TabsTrigger>
          <TabsTrigger value="layout" className="flex-1 min-w-[4.5rem] text-xs sm:text-sm">
            Layout
          </TabsTrigger>
        </TabsList>
          ...
          {selectedTableId && (
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">
                ...
                editability per field. On the page, use Edit layout to fine-tune the layout.
              </p>
        ...
        {/* Left Panel tab */}
        <TabsContent value="left_panel" className="mt-6 space-y-6">
