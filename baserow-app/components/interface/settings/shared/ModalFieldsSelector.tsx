...
export default function ModalFieldsSelector({
  value,
  onChange,
  fields,
  label = "Fields to Show in Modal",
  description,
}: ModalFieldsSelectorProps) {
        ...
        <div>
          ...
          {description ? (
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              Choose which fields appear when clicking on a record. Drag to reorder. Leave empty to
              show all fields.
            </p>
          )}
        </div>
          ...
          <div className="space-y-2 max-h-[200px] overflow-y-auto border border-gray-200 rounded-md p-2">
            {selectedFields.length > 0 ? (
              ...
              <p className="text-xs text-gray-400 italic text-center py-4">
                No fields selected. All fields will be shown in the modal. Add fields using the
                dropdown above to limit what&apos;s displayed.
              </p>
            )}
          </div>
        </SortableContext>
