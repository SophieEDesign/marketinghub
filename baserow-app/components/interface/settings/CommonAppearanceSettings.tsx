      ...
      <div className="space-y-4">
        ...
        {appearance.showTitle !== false && (
          <>
            ...
            {/* Autofit Toggle */}
            <div className="flex items-center justify-between py-2 border-t pt-3 mt-3">
              <div className="flex flex-col">
                <label className="text-sm font-medium text-gray-700">Auto-fit Height</label>
                <p className="text-xs text-gray-500">Automatically adjust block height to fit content</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  checked={(appearance as any)?.autofit_enabled !== false}
                  onChange={(e) => {
                    onUpdate({ autofit_enabled: e.target.checked } as any)
                  }}
