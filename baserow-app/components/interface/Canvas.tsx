          ...
          onDrag={(layout, oldItem, newItem, placeholder, e, element) => {
            ...
            if (isEditing) {
              ...
              if (isVerticalDrag) {
                ...
                if (snapTargets.left) {
                  if (bestSnap === null || snapTargets.left.distance < bestSnap.distance) {
                ...
                if (snapTargets.right) {
                  if (bestSnap === null || snapTargets.right.distance < bestSnap.distance) {
                    bestSnap = { type: 'vertical', x: snapTargets.right.targetX, blockId: snapTargets.right.block.i, distance: snapTargets.right.distance }
                  }
                }
                if (snapTargets.top) {
                  if (bestSnap === null || snapTargets.top.distance < bestSnap.distance) {
                ...
                if (snapTargets.bottom) {
                  if (bestSnap === null || snapTargets.bottom.distance < bestSnap.distance) {
