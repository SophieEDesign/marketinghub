...
export const RECORD_LAYOUT_PRESETS: Record<Exclude<RecordLayoutType, "generic">, RecordLayoutPreset> = {
  social_post: {
    ...
    sections: [
      { id: "post_summary", label: "Post summary", aliases: aliases(["title", "name", "status"]) },
      { id: "caption_content", label: "Caption / content", aliases: aliases(["caption", "content", "post text", "copy"]) },
      { id: "media", label: "Media", aliases: aliases(["image", "media", "thumbnail", "file", "asset"]) },
      { id: "scheduling", label: "Scheduling", aliases: aliases(["date", "publish date", "scheduled", "time"]) },
      { id: "campaign_theme", label: "Campaign / theme", aliases: aliases(["campaign", "category", "theme"]) },
      { id: "approval", label: "Approval", aliases: aliases(["approval", "approval status", "review", "approved"]) },
      { id: "social_channels", label: "Social channels", aliases: aliases(["channel", "platform", "instagram", "linkedin", "facebook", "tiktok", "youtube", "twitter"]) },
      { id: "event_links", label: "Event links", collapsedByDefault: true, aliases: aliases(["event", "events", "linked event"]) },
    ],
  },
  event: {
    priorityAliases: aliases([
