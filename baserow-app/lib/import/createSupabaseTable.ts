...
/**
 * Alternative: Create table using direct SQL execution
 * This requires a PostgreSQL function that can execute dynamic SQL
 */
export async function createSupabaseTableWithSQL(
  tableName: string,
  columns: ColumnDefinition[]
): Promise<string> {
  const columnDefinitions = columns
