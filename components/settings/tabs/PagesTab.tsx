...
import { Layout, Plus, Edit2, Eye, Trash2 } from "lucide-react";
...
export default function PagesTab() {
  ...
  if (loading) {
    return (
      <div className="text-sm text-gray-500 dark:text-gray-400">Loading pages...</div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Interface Pages</h2>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            Create and manage custom interface pages with blocks
          </p>
        </div>
