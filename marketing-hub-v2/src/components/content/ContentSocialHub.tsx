  ...
  return (
    <div>
      <PageHeader
        ...
        description="Draft in the Hub. Approved sends one Facebook draft to Planable with the due date — add LinkedIn and Instagram there, then schedule, approve and publish. Published posts lock in the Hub."
        actions={
