  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        // Open Graph
        { hid: 'og:site_name', property: 'og:site_name', content: 'P&M Interface Builder' },
        { hid: 'og:type', property: 'og:type', content: 'website' },
        { hid: 'og:title', property: 'og:title', content: 'P&M Interface Builder' },
        {
          hid: 'og:description',
          property: 'og:description',
          content:
            'P&M Interface Builder provides an intuitive interface for managing your data with customizable views, forms, and dashboards.',
        },
        { hid: 'og:url', property: 'og:url', content: 'https://interface.petersandmay.com' },
        // Twitter
        { hid: 'twitter:card', name: 'twitter:card', content: 'summary_large_image' },
        { hid: 'twitter:title', name: 'twitter:title', content: 'P&M Interface Builder' },
        {
